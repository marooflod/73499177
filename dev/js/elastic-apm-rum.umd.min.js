! function() {
    ...
    n.n = function(t) {
        ...
        function() {
            ...
            function f(t, e) {
                try {
                    ...
                    if (e && ("object" == typeof e || "function" == typeof e)) {
                        ...
                        if ("function" == typeof n) return void v((r = n, i = e, function() {
                            r.apply(i, arguments)
                        }), t)
                    }
            ...
            var h = c,
                g = {};
            S ? g = window : "undefined" != typeof self && (g = self);
            var m = "Promise" in g ? g.Promise : h,
                y = [].slice,
                S = "undefined" != typeof window,
                _ = S && "undefined" != typeof performance ? performance : {};
            for (var b = [], T = 0; T < 256; ++T) b[T] = (T + 256).toString(16).substr(1);
            var w = new Uint8Array(16);

            function E(t) {
                return function(t) {
                    for (var e = [], n = 0; n < t.length; n++) e.push(b[t[n]]);
                    return e.join("")
                }("undefined" != typeof crypto && "function" == typeof crypto.getRandomValues ? crypto.getRandomValues(w) : "undefined" != typeof msCrypto && "function" == typeof msCrypto.getRandomValues ? msCrypto.getRandomValues(w) : w).substr(0, t)
            }
            ...
            function L() {
                return S && "function" == typeof Set && "function" == typeof JSON.stringify && _ && "function" == typeof _.now && "withCredentials" in new window.XMLHttpRequest
            }
                ...
                for (var r = 0, i = e.length; r < i; ++r) {
                    ...
                    if (O(a) || "function" == typeof a)
                        for (var o = Object.keys(a), s = 0, c = o.length; s < c; s++) {
                            var u = o[s],
                                f = a[u];
                            n && O(f) ? (O(t[u]) || (t[u] = Array.isArray(f) ? [] : {}), I(t[u], [f], !1)) : t[u] = f
                        }
                }
                return t
            }
            ...
            function nt(t, e) {
                var n = void 0 === e ? {} : e,
                    ...
                    a = {};
                if (t.type === Z && U()) {
                    var o = _.getEntriesByType("navigation");
                    o && o.length > 0 && (a = {
                        response: K(o[0])
                    })
                }
            ...
            function St(t, e, n) {
                ...
                if (r && !(i = r[c])) {
                    ...
                    if (!(s = u) || !1 !== s.writable && ("function" != typeof s.get || void 0 !== s.set)) {
                        ...
                        }, a = r[e], o = i, a[yt("OriginalDelegate")] = o
                    }
                }
                return i
            }
            var _t = yt("xhrIgnore"),
                ...
                Et = function() {
                    function t(t, e, n) {
                        void 0 === n && (n = {}), t || (t = "Unknown"), e || (e = "custom"), this.name = t, this.type = e, this.options = n, this.id = n.id || E(16), this.traceId = n.traceId, this.sampled = n.sampled, this.sampleRate = n.sampleRate, this.timestamp = n.timestamp, this._start = H(n.startTime), this._end = void 0, this.ended = !1, this.outcome = void 0, this.onEnd = n.onEnd
                    }
                    var e = t.prototype;
                    return e.ensureContext = function() {
                        ...
                        0 !== e.length && (this.ensureContext(), R.apply(void 0, [this.context].concat(e)))
                    }, e.end = function(t) {
                        this.ended || (this.ended = !0, this._end = H(t), this.callOnEnd())
            ...
            var kt = function(t) {
                    ...
                    return n = t, (e = r).prototype = Object.create(n.prototype), e.prototype.constructor = e, xt(e, n), r.prototype.end = function(e, n) {
                            ...
                            for (var i = [], a = 0; a < Ct.length; a++) {
                                ...
                                if (Nt(o, s, n, r, e)) {
                                    var c = new kt(Ct[a][2], "hard-navigation.browser-timing"),
                                        u = null;
                                    "requestStart" === Ct[a][0] && (c.pageResponse = !0, u = {
                                        url: location.origin
                        ...
                        (function(t, e, n, r) {
                            for (var i = [], a = 0; a < t.length; a++) {
                                var o = t[a],
                                    ...
                                    c = o.name,
                                    u = o.startTime,
                                    f = o.responseEnd; - 1 !== G.indexOf(s) && null != c && (("xmlhttprequest" === s || "fetch" === s) && (/intake\/v\d+\/rum\/events/.test(c) || It(u, e)) || Nt(u, f, n, r) && i.push(Ot(t[a])))
                            }
                            return i
                        })(_.getEntriesByType("resource"), Lt.bootstrapTime, i, e).forEach((function(e) {
                            ...
                            function(t, e, n) {
                                ...
                                return r
                            }(_.getEntriesByType("measure"), i, e).forEach((function(e) {
                                return t.spans.push(e)
                            }))
                    }
                }
            ...
            function Pt(t) {
                ...
                if (n && (e.p = {
                        ...
                        var e = {},
                            ...
                            i = t.url,
                            a = t.response;
                        return e.url = i, n && (e.mt = n), r && (e.sc = r), a && (e.r = At(a)), e
                    }(r)), i && (e.r = At(i)), a) {
                    var c = a.service;
                    e.dt = {
                        se: {
            ...
            function Mt(t) {
                ...
                var e = function(t) {
                    if (!t) return null;
                    var e = {};
                    return Ft.forEach((function(n, r) {
                        var i = jt[r];
                        e[n] = t[i]
                    })), e
                }(t.navigationTiming);
            ...
            var zt = function() {
                    function t(t, e) {
                        this._configService = t, this._loggingService = e, this.queue = void 0, this.throttleEvents = A
                    }
                    var e = t.prototype;
                    return e.init = function() {
                        ...
                        return new m((function(n, r) {
                            ...
                            if (i[_t] = !0, i.open(t, e, !0), i.timeout = a, s)
                                for (var u in s) s.hasOwnProperty(u) && i.setRequestHeader(u, s[u]);
                        ...
                        if (!t) return m.reject("serviceName is required for fetching central config.");
                        ...
                        return t.map((function(t) {
                            ...
                            })).join(""), delete t.spans), t.breakdown && (o = n.ndjsonMetricsets(t.breakdown), delete t.breakdown)), gt.stringify(((i = {})[r] = e ? function(t) {
                            ...
                            if (0 !== r.length || 0 !== i.length) {
                                ...
                                if (u) {
                                    var f = s.get("apiVersion"),
                                        d = f > 2,
                                        l = [],
                                        p = this.createMetaData(),
                                        v = d ? "m" : "metadata";
                                    l.push(gt.stringify(((n = {})[v] = d ? function(t) {
                                        var e = t.service,
                                            n = t.labels,
                                            r = e.agent,
                                            i = e.language;
                                    ...
                                    var h = (l = l.concat(this.ndjsonErrors(u.errors, d), this.ndjsonTransactions(u.transactions, d))).join(""),
                                        g = s.get("serverUrlPrefix") || "/intake/v" + f + "/rum/events",
                                        m = s.get("serverUrl") + g;
                                    return this._postJson(m, h)
                                }
            ...
            var Bt, $t = function() {
                    function t() {
                        this.config = {
                            ...
                            session: !1,
                            apmRequest: null
                        }, this.events = new Dt, this.filters = [], this.version = ""
                    }
                    var e = t.prototype;
                    return e.init = function() {
                        var t = function(t) {
                        ...
                        var e = {},
                            ...
                            i = n.username,
                            a = n.email;
                        "number" != typeof r && "string" != typeof r || (e.id = r), "string" == typeof i && (e.username = i), "string" == typeof a && (e.email = a), this.config.context.user = F(this.config.context.user || {}, e)
                    }, e.setCustomContext = function(t) {
                        void 0 === t && (t = {}), this.config.context.custom = F(this.config.context.custom || {}, t)
                    }, e.addLabels = function(t) {
                        var e = this;
                        ...
                        var e = t,
                            ...
                            r = e.serverUrl;
                        r && (t.serverUrl = r.replace(/\/+$/, "")), q(n) || (n < 1e-4 && n > 0 && (n = 1e-4), t.transactionSampleRate = Math.round(1e4 * n) / 1e4), R(this.config, t), this.events.send("config:change", [this.config])
                        ...
                        if (t) {
                            if (e) t = Ut({}, this.getLocalConfig(), t);
            ...
            function Gt(t) {
                ...
                if (e && e.addEventListener) var n = St(e, "open", (function() {
                        return function(t, e) {
                            return t[_t] || (t[wt] = e[0], t[Tt] = e[1], t[bt] = !1 === e[2]), n.apply(t, e)
                        }
                    })),
                    r = St(e, "send", (function() {
                        return function(e, n) {
                            if (e[_t]) return r.apply(e, n);
                            var a = {
            ...
            for (var Zt = ["click"], Yt = {}, Wt = 0; Wt < Zt.length; Wt++) {
                var Kt = Zt[Wt];
                Yt[Kt] = yt(Kt)
            }

            function Qt(t, e, n) {
                return t instanceof EventTarget && Zt.indexOf(e) >= 0 && "function" == typeof n
            }
            var te = new Dt,
                ee = !1;

            function ne() {
                return ee || (ee = !0, Gt((function(t, e) {
                    te.send("xmlhttprequest", [t, e])
                })), function(t) {
                    if (window.fetch && window.Request) {
                        ...
                        window.fetch = function(t, i) {
                            var a, o, s = this,
                                c = arguments;
                            if ("string" == typeof t) a = new Request(t, i), o = t;
                            else {
                            ...
                            return new m((function(t, i) {
                                var o;
                                mt.fetchInProgress = !0, n(u);
                                try {
                                    o = e.apply(s, [a])
                                } catch (t) {
                                    return i(t), u.data.error = t, r(u), void(mt.fetchInProgress = !1)
                                }
                                o.then((function(e) {
                                    t(e), D((function() {
                    ...
                    if (window.EventTarget) {
                        ...
                        e.addEventListener = function(t, e, r) {
                            var i = this;
                            if (!Qt(i, t, e)) return n.apply(i, arguments);
                            var a = o(i, t, e, r),
                                s = Array.prototype.slice.call(arguments);
                            return s[1] = a, n.apply(i, s)
                        }, e.removeEventListener = function(t, e, n) {
                            var i = this;
                            if (!Qt(i, t, e)) return r.apply(i, arguments);
                            var a = s(i, t, e, n),
                                o = Array.prototype.slice.call(arguments);
                            return o[1] = a, r.apply(i, o)
                        }
                    }
                    ...
                    function i(t, e, n, r) {
                        for (var i = 0; i < t.length; i++) {
                            var a = t[i];
                            if (a.eventType === e && a.listenerFn === n && a.capture === r) return i
                        }
                        return -1
                    }
                    ...
                    function o(e, n, r, o) {
                        ...
                        function l() {
                            var e, n = arguments[0];
                            d.target = n.target, t("schedule", d);
                            try {
                    ...
                    function s(t, e, n, r) {
                        ...
                        if (s) {
                            ...
                            if (-1 !== c) {
                                var u = s[c];
                                return s.splice(c, 1), 0 === s.length && (t[o] = void 0), u.wrappingFn
                            }
                        }
                        return n
                    }
                }((function(t, e) {
                    te.send("eventtarget", [t, e])
                }))), te
            }
            var re = function() {
                    function t(t, e, n, r) {
                    ...
                    return e.init = function(t) {
                        ...
                        })), t.history && te.observe("history", this.getHistorySub()), t.xmlhttprequest && te.observe("xmlhttprequest", this.getXHRSub()), t.fetch && te.observe("fetch", this.getFetchSub()), t.eventtarget && te.observe("eventtarget", this.getEventTargetSub())
                        ...
                        return function(e, n) {
                            if ("schedule" === e && "eventtarget" === n.source && "click" === n.eventType) {
                                var r = n.target,
                                    ...
                                    a = i;
                                if (r.dataset.transactionName) a = r.dataset.transactionName;
                                else {
                                    var o = r.getAttribute("name");
                                    o && (a = i + '["' + o + '"]')
                                }
                                var s = t.startTransaction("Click - " + a, "user-interaction", {
                                    managed: !0,
                                    canReuse: !0,
                                    reuseThreshold: 300
                                });
                        ...
                        if ("schedule" === t && e.data) {
                            var i = e.data,
                                a = new J(i.url),
                                o = i.method + " " + (a.relative ? a.path : N(a.href));
                            ...
                            var c = n.get("distributedTracing"),
                                ...
                                l = i.target;
                            if (c && d && l) this.injectDtHeader(s, l), n.get("propagateTracestate") && this.injectTSHeader(s, l);
                            else 0;
                            i.sync && (s.sync = i.sync), i.span = s
                        } else if (t === X) {
                            var p = e.data;
                            if (p && p.span) {
                                var v, h, g = p.span,
                                    m = p.response,
                                    y = p.target;
                                v = m ? m.status : y.status, "abort" != p.status && (h = v >= 400 || 0 == v ? "failure" : "success"), g.outcome = h;
                                var S = r.getCurrentTransaction();
                                S && "http-request" === S.type && (S.outcome = h), r.endSpan(g, p)
                            }
                        }
                        ...
                        /^[\da-f]{2}-[\da-f]{32}-[\da-f]{16}-[\da-f]{2}$/.test(n = i) && "00000000000000000000000000000000" !== n.slice(3, 35) && "0000000000000000" !== n.slice(36, 52) && i && r && x(e, r, i)
            ...
            var ce = function(t) {
                    ...
                    function r(e, n, r) {
                        var i;
                        return (i = t.call(this, e, n, r) || this).traceId = E(), i.marks = void 0, i.spans = [], i._activeSpans = {}, i._activeTasks = new Set, i.blocked = !1, i.captureTimings = !1, i.breakdownTimings = [], i.sampleRate = i.options.transactionSampleRate, i.sampled = Math.random() <= i.sampleRate, i
                    }
                    n = t, (e = r).prototype = Object.create(n.prototype), e.prototype.constructor = e, se(e, n);
                    var i = r.prototype;
                    return i.addMarks = function(t) {
                        ...
                        t && (this.name = t), e && (this.type = e), n && F(this.options, n)
                        ...
                        if (!this.ended) {
                            for (var e in this.ended = !0, this._end = H(t), this._activeSpans) {
                        ...
                        return t || (t = "task-" + E(16)), this._activeTasks.add(t), t
            ...
            function fe(t, e) {
                ...
                return p && (ue.fid = p.duration(), a.spans.push(p)),
                    function(t) {
                        t.forEach((function(t) {
                            var e = t.name,
                                n = t.startTime,
                                r = t.duration;
                            if (!(n < ue.fcp || "self" !== e && -1 === e.indexOf("same-origin"))) {
                    ...
                    function(t) {
                        t.forEach((function(t) {
                            !t.hadRecentInput && t.value && ((t.startTime - ue.cls.firstEntryTime > 5e3 || t.startTime - ue.cls.prevEntryTime > 1e3) && (ue.cls.firstEntryTime = t.startTime, ue.cls.currentSessionScore = 0), ue.cls.prevEntryTime = t.startTime, ue.cls.currentSessionScore += t.value, ue.cls.score = Math.max(ue.cls.score, ue.cls.currentSessionScore))
                        }))
            ...
            var de = function() {
                ...
                le = function() {
                    function t(t, e) {
                        var n = this;
                        this._config = e, this._logger = t, this.currentTransaction = void 0, this.respIntervalId = void 0, this.recorder = new de((function(t) {
                    ...
                    return e.createCurrentTransaction = function(t, e, n) {
                        ...
                        var r, i = this,
                            ...
                            o = !0;
                        a.managed ? this.currentTransaction === (r = this.startManagedTransaction(t, e, a)) && (o = !1) : r = new ce(t, e, a);
                        ...
                        return m.resolve().then((function() {
                            ...
                            if (!(Lt.lastHiddenStart >= t._start || e.shouldIgnoreTransaction(r) || "temporary" === i)) {
                                if (i === Z) {
                                    ...
                                    if ("Unknown" === r && a && (t.name = a), t.captureTimings) {
                                        var o = ue.cls,
                                            ...
                                            c = ue.tbt,
                                            u = ue.longtask;
                                        c.duration > 0 && t.spans.push((d = (f = c).start, l = f.duration, (p = new kt("Total Blocking Time", "longtask", {
                                            startTime: d
                                        })).end(d + l), p)), t.experience = {}, B("longtask") && (t.experience.tbt = c.duration), B("layout-shift") && (t.experience.cls = o.score), s > 0 && (t.experience.fid = s), u.count > 0 && (t.experience.longtask = {
                                            count: u.count,
                                            sum: u.duration,
                                            max: u.max
                                        })
                                ...
                                }(n)), qt(t), e.adjustTransactionTime(t), e._config.get("breakdownMetrics") && t.captureBreakdown();
                        ...
                        for (var i = t._end, a = 0; a < e.length; a++) {
                            var o = e[a];
                            o._end > i && (o._end = i, o.type += ".truncated"), o._start > i && (o._start = i)
                        }
            ...
            function he() {
                ...
                }(), Lt.bootstrapTime = M(), ve = !0) : S && console.log("[Elastic APM] platform is not supported!"), ve
            }
            var ge = function() {
                function t(t, e) {
                ...
                return e.isEnabled = function() {
                    ...
                    if (this.isEnabled() && !this._initialized) {
                        ...
                        var n = this.serviceFactory.getService(["ConfigService", "LoggingService"]),
                            r = n[0],
                            i = n[1];
                        r.setVersion("5.10.2"), this.config(t);
                        var a = r.get("logLevel");
                        if (i.setLevel(a), r.get("active")) {
                            this.serviceFactory.init();
                            var o = function(t, e) {
                                var n, r = ((n = {}).xmlhttprequest = !1, n.fetch = !1, n.history = !1, n[Z] = !1, n.error = !1, n.eventtarget = !1, n);
                                return t ? (Object.keys(r).forEach((function(t) {
                                    -1 === e.indexOf(t) && (r[t] = !0)
                                })), r) : r
                            }(r.get("instrument"), r.get("disableInstrumentations"));
                            if (this.serviceFactory.getService("PerformanceMonitoring").init(o), o.error) this.serviceFactory.getService("ErrorLogging").registerListeners();
                            if (r.get("session")) {
                            ...
                            var c = function() {
                                return o[Z] && e._sendPageLoadMetrics()
                            };
                    ...
                    if (0 === r.length && 0 === i.length) e.setConfig(t);
                        ...
                        r.length > 0 && (o += r.join(", ") + " is missing", i.length > 0 && (o += ", ")), i.forEach((function(t, e) {
                            var n = t.key,
                                r = t.value,
                                a = t.allowed;
                            o += n + ' "' + r + '" contains invalid characters! (allowed: ' + a + ")" + (e !== i.length - 1 ? ", " : "")
                        })), a.error(o), e.setConfig({
                            active: !1
                        })
                    }
                }, e.setUserContext = function(t) {
            ...
            var me = function() {
                if (S && window.elasticApm) return window.elasticApm;
                var t = he(),
                    e = pe(),
                    n = new ge(e, !t);
                return S && (window.elasticApm = n), n
            }();
            me.init.bind(me)
        }()
}();
